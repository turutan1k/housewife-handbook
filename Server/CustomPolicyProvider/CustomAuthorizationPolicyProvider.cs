...
namespace Web.CustomPolicyProvider
{
    ...
    public static class DynamicAuthorizationPolicyFactory//
    {
        public static AuthorizationPolicy Create(string policyName)//
        {
            ...
            switch (type)
            {
                case DynamicPolicies.Rank : return new AuthorizationPolicyBuilder().RequireClaim("Rank, value").Build();
                case DynamicPolicies.SecurityLevel : return new AuthorizationPolicyBuilder().AddRequirements(new SecurityLevelRequirement(Convert.ToInt32(value))).Build();
                default : return null;
